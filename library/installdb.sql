...
(9, 'Замечательная статья', '<p>Это самая замечательная статья в мире.</p><p>Она содержит множество полезной информации.</p><p>Посетители сайта приходят в восторг, прочитав этут статью, и сохраняют её себе в закладки.</p>'),
